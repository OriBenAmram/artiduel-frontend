...
export function UserModal({ onLogout, toggleUserModal }: UserModalProps) {
    ...
    function onDown(ev: MouseEvent | TouchEvent<HTMLDivElement>) { 
        ...
        const dragPercent = getDragPercent(dif, modalHeight)
        setModalOptions((prevOpts: IModalOpts) => ({ ...prevOpts as IModalOpts, modalTop: top, modalHeight: height, dragPercent,  diff: 0, dragStartY: mousePosY}))
    }
