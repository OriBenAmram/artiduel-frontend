...
interface UserModalProps {
    ...
    toggleUserModal: MouseEventHandler<HTMLAnchorElement> | TouchEventHandler<HTMLAnchorElement> | undefined
}
...
export function UserModal({ onLogout, toggleUserModal }: UserModalProps) {
    ...
    useEffect(() => {
        if (modalOptions.dragPercent > 100) toggleUserModal(undefined!)
    }, [modalOptions])
