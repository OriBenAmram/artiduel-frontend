...
export function DrawPreview({ draw }: DrawPreviewProps) {
    ...
    const onLikeDrawing = async (player: any) => {
        ...
        const chosedPlayer = player === 'player1' ? drawToSave.player1 : drawToSave.player2
        const likeIdx = chosedPlayer.likes.findIndex((l: ILikeEntity) => l.userId === loggedInUser._id)
        if (likeIdx === -1) chosedPlayer.likes.push(like)
        else chosedPlayer.likes.splice(likeIdx, 1)
    ...
    return <article className="draw-preview">
        ...
        <div className="draw-preview__first-draw">
            ...
            <div className="draw-preview__user-bar">
                {getLikeIconToDisplay(draw.player1, 'player1')}
        ...
        <div className="draw-preview__second-draw">
            ...
            <div className="draw-preview__user-bar">
                {getLikeIconToDisplay(draw.player2, 'player2')}
                <div className="draw-preview__user-details-container">
